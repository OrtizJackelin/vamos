<?php
    ...
    $consulta = "SELECT fecha_solicitud, estado, fecha_revision FROM solicitud_verificacion WHERE id_usuario = ?";
                ...
                if ($check !== false) {
                    ...
                    if ($tamanoArchivo <= $maxFileSize) {                       
                        ...
                        if (move_uploaded_file($archivoTmpName, $directorioDestino . $nombreFotoDocumento)) {
                            ...
                            $consulta = "INSERT INTO solicitud_verificacion (id_usuario, documento, comentario) 
                                        VALUE  (?, ?, ?)";
                            ...
                            if(!$sentencia->prepare($consulta)) {
                                ...
                                if($sentencia->affected_rows <= 0) {
                                    $mensaje = $mensaje . "error guardando datos<br>"; 
                                    $valido = false;
                                }
                                $sentencia->close(); 
                            }
        ...
        <?php if(!$solicitudEnProceso) { ?>
            <section class = "sectionPrincipal">
                <div class="container w-75 ">
                    ...
                    <form class="row g-5 p-5 " id="formulario" method="post" action="verificarCuenta.php" enctype = "multipart/form-data" >
