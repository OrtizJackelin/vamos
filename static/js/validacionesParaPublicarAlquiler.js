...
function validarLongitudTitulo(titulo) {
    var valor = titulo; // Aquí obtienes el valor del input, no solo el valor del título.
    ...
    if (valor.trim() !== "") {
        ...
        return true; // Devolver true solo si la validación pasa.
    } else {
